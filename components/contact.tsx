...
export function Contact() {
  const contactInfo = [
    ...
    { icon: Phone, label: "Phone", value: "+216 54 233 009", href: "tel:+21654233009" },
    { icon: Globe, label: "Portfolio", value: "portfolioseif.vercel.app", href: "https://portfolioseif.vercel.app/" },
    { icon: Github, label: "GitHub", value: "SeifeddineJaziri", href: "https://github.com/SeifeddineJaziri" },
    {
      icon: Linkedin,
      label: "LinkedIn",
    ...
    <section id="contact" className="py-20 px-4 mb-20">
      <div className="container mx-auto">
              ...
              {contactInfo.map((contact, idx) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-card-foreground">{contact.value}</p>
                  </div>
                </a>
              ))}
            </div>
        ...
        <footer className="mt-16 text-center text-sm text-muted-foreground">
          <p>© 2025 Seifeddine JAZIRI. Built with Next.js & React Three Fiber.</p>
        </footer>
      </div>
    </section>
  )
