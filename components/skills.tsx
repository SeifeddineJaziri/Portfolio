...
const skillCategories = [
  {
    icon: Code,
    title: "Frontend",
    skills: ["React.js", "Next.js", "Angular", "HTML/CSS", "JavaScript", "TypeScript"],
  },
  {
    icon: Server,
    title: "Backend",
  ...
  },
  {
    ...
    skills: ["YOLO", "OpenCV", "LangChain", "LangGraph", "Mediapipe", "RAG", "MCP"],
  },
  {
    icon: Smartphone,
    title: "Mobile & Tools",
    skills: ["Flutter", "Riverpod", "Git", "Postman", "VS Code", "Qdrant", "Elasticsearch"],
  },
]
